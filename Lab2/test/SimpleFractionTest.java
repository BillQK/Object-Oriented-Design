...
/**
 * This is a testing class for SimpleFraction, including testing the class behavior and
 * restriction.
 */
public class SimpleFractionTest {
  ...
  @Test
  public void testAdd() {
    assertEquals(a.add(3, 4).toString(), "6/4");
    assertEquals(b.add(3, 25).toString(), "13/25");
  ...
  // TODO: Ask how to test when a Fraction
  // TODO:is negative whereas fraction created
  // TODO: with numerator -4 and denominator -9 should return "4/9"
}