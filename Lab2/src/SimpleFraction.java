...
public class SimpleFraction implements Fraction {
  ...
  public Fraction add(int numerator, int denominator) throws IllegalArgumentException {
    ...
    if (this.denominator != denominator) {
      ...
      int sumNumerator = newNumerator + (numerator * this.denominator);
      return new SimpleFraction(sumNumerator, newDenominator);

    } else {
      return new SimpleFraction(this.numerator + numerator, this.denominator);
    }
  }
